...
::::: columns
::: {.column width="35%"}
# [Yi Huang](cv.zh.qmd){.name-link style="color:#111; text-decoration:none;font-weight:700;"}
![](yihuang_fig/yihuang_profile.jpeg){fig-alt="Yi Huang 个人照片" width="80%" fig-align="left"}
:::
