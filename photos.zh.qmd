...
<div class="photo-page">
  <div class="photo-carousel" data-photo-carousel>
    ...
    <button class="photo-nav photo-nav-prev" type="button" aria-label="上一张照片">&lsaquo;</button>
    <button class="photo-nav photo-nav-next" type="button" aria-label="下一张照片">&rsaquo;</button>

    <div class="photo-dots" aria-label="照片导航"></div>
  </div>
</div>
...
document.addEventListener("DOMContentLoaded", () => {
  document.querySelectorAll("[data-photo-carousel]").forEach((carousel) => {
    ...
    const dots = slides.map((_, slideIndex) => {
      ...
      dot.setAttribute("aria-label", `显示第 ${slideIndex + 1} 张照片`);
